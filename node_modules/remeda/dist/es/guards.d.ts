 ...
 * @category Guard
 */
export declare function isString<T>(data: T | string): data is DefinitelyString<T>;
 ...
 * @category Guard
 */
export declare function isNumber<T>(data: T | number): data is DefinitelyNumber<T>;
/**
 ...
 * @category Guard
 */
export declare function isArray<T>(data: T | ReadonlyArray<unknown>): data is DefinitelyArray<T>;
 ...
 * @category Guard
 */
export declare function isObject<T extends unknown>(data: T | object): data is DefinitelyObject<T>;
 ...
 * @category Guard
 */
export declare function isFunction<T>(data: T | Function): data is DefinitelyFunction<T>;
/**
 ...
 * @category Guard
 */
export declare function isError<T>(data: T | Error): data is DefinitelyError<T>;
/**
 ...
 * @category Guard
 */
export declare function isTruthy<T>(data: T): data is Exclude<T, null | undefined | false | '' | 0>;
/**
